...
INSERT INTO `comida_tiene_restriccion` VALUES (21,1003,1),(1,1004,2),(22,1008,1),(2,1008,2),(23,1010,1),(3,1012,2),(24,1016,1),(4,1016,2),(25,1020,1),(5,1020,2),(26,1024,1),(6,1024,2),(27,1026,1),(7,1028,2),(28,1032,1),(8,1032,2),(29,1036,1),(9,1036,2),(30,1040,1),(10,1040,2),(31,1044,1),(11,1044,2),(32,1046,1),(12,1048,2),(33,1052,1),(13,1052,2),(34,1053,1),(14,1056,2),(35,1058,1),(15,1060,2),(16,1064,2),(36,1067,1),(37,1068,1),(17,1068,2),(38,1072,1),(18,1072,2),(39,1074,1),(19,1076,2),(40,1080,1),(20,1080,2);
...
INSERT INTO `comidas` VALUES (1001,1,'Budín de queso azul',0,NULL,1),(1002,2,'Carne estofada con polenta',0,NULL,1),(1003,3,'Albóndigas de lentejas estofadas',0,NULL,1),(1004,4,'Tortilla de zapallitos a la pizza',0,NULL,1),(1005,1,'Pastafrola de verduras',0,NULL,1),(1006,2,'Milanesa de cerdo napolitana con puré de papas',0,NULL,1),(1007,3,'Ñoquis con salsa mixta',0,NULL,1),(1008,4,'Vegetales con garbanzos al curry',0,NULL,1),(1009,1,'Soufflé de coles',0,NULL,1),(1010,2,'Pollo al limón con arroz al azafrán',0,NULL,1),(1011,3,'Canastitas de choclo fiorentina',0,NULL,1),(1012,4,'Tarta de hongos, verdeo y queso',0,NULL,1),(1013,1,'Paquetitos de hongos',0,NULL,1),(1014,2,'Pastas a las 3 salsas',0,NULL,1),(1015,3,'Rollito de pescado con papas hervidas',0,NULL,1),(1016,4,'Medallón de quinoa y verduras',0,NULL,1),(1017,1,'Milhojas de papa',0,NULL,1),(1018,2,'Bife a la criolla con verduras',0,NULL,1),(1019,3,'Pastel de pollo',0,NULL,1),(1020,4,'Arroz al champiñón, frutos secos y pasas',0,NULL,1),(1021,1,'Pizza fugazza',0,NULL,1),(1022,2,'Cerdo con salsa de mostaza y miel con papas cebolladas',0,NULL,1),(1023,3,'Omelette de verdura con tomate y queso',0,NULL,1),(1024,4,'Polenta con queso azul, cebolla caramelizada, brotes y maní',0,NULL,1),(1025,1,'Torrejas mixtas',0,NULL,1),(1026,2,'Pollo a la barbacoa con puré amarillo',0,NULL,1),(1027,3,'Budín de zapallitos',0,NULL,1),(1028,4,'Tarta de berenjena, verdeo y nueces',0,NULL,1),(1029,1,'Quiche de verduras',0,NULL,1),(1030,2,'Hamburguesas con fideos al champiñón',0,NULL,1),(1031,3,'Soufflé de puerro y queso',0,NULL,1),(1032,4,'Lentejas guisadas',0,NULL,1),(1033,1,'Budín mediterráneo',0,NULL,1),(1034,2,'Filet de pollo con chip de batatas',0,NULL,1),(1035,3,'Tarta de cebolla y queso',0,NULL,1),(1036,4,'Risotto de calabaza',0,NULL,1),(1037,1,'Bombas de papa',0,NULL,1),(1038,2,'Lasaña de verduras, jamón, queso y bolognesa',0,NULL,1),(1039,3,'Pizza napolitana',0,NULL,1),(1040,4,'Garbanzos cremosos con cebolla caramelizada, espinaca y tomate',0,NULL,1),(1041,1,'Soufflé de choclo y queso',0,NULL,1),(1042,2,'Carne al roquefort con puré de batata',0,NULL,1),(1043,3,'Alubias guisadas',0,NULL,1),(1044,4,'Zapallitos rellenos con quinoa',0,NULL,1),(1045,1,'Tortilla de papa',0,NULL,1),(1046,2,'Arroz amarillo con pollo',0,NULL,1),(1047,3,'Ravioles a la bolognesa',0,NULL,1),(1048,4,'Pizza integral de cebolla, queso azul y calabaza',0,NULL,1),(1049,1,'Budín de zanahoria',0,NULL,1),(1050,2,'Pastel de papa',0,NULL,1),(1051,3,'Omelette de jamón y queso',0,NULL,1),(1052,4,'Risotto de espinaca y nueces caramelizadas',0,NULL,1),(1053,1,'Croquetas de arroz',0,NULL,1),(1054,2,'Milanesa de carne con revuelto de verdura',0,NULL,1),(1055,3,'Tarta gallega',0,NULL,1),(1056,4,'Ñoquis capresse',0,NULL,1),(1057,1,' Pascualina',0,NULL,1),(1058,2,' Filet de merluza con puré',0,NULL,1),(1059,3,' Fajitas de pollo',0,NULL,1),(1060,4,' Curry de lentejas',0,NULL,1),(1061,1,'Tortilla de zapallitos',0,NULL,1),(1062,2,'Pastas con salsa con carne cubeteada',0,NULL,1),(1063,3,'Tarta de queso azul, puerro y nueces',0,NULL,1),(1064,4,'Coles al bechamel',0,NULL,1),(1065,1,'Pizza capresse',0,NULL,1),(1066,2,'Medallón de pollo con papa y calabaza',0,NULL,1),(1067,3,'Pescado a la fiorentina',0,NULL,1),(1068,4,'Risotto de zapallo, queso azul y cebolla caramelizada',0,NULL,1),(1069,1,'Empanadas de puerro',0,NULL,1),(1070,2,'Pan de carne con bastones de zanahoria',0,NULL,1),(1071,3,'Tacos de carne',0,NULL,1),(1072,4,'Berenjena con tajos de espinaca, queso y nueces',0,NULL,1),(1073,1,'Bombas de papa',0,NULL,1),(1074,2,'Guiso de lentejas',0,NULL,1),(1075,3,'Pizza de hongos',0,NULL,1),(1076,4,'Canelones de verdura con salsa blanca',0,NULL,1),(1077,1,' Tarta de jamón y queso',0,NULL,1),(1078,2,' Suprema con colchón de arvejas y verduras',0,NULL,1),(1079,3,' Omelette de queso y aceitunas',0,NULL,1),(1080,4,' Bowl de quinoa y verduras',0,NULL,1),(1081,5,'Agua mineral',0,NULL,1),(1082,5,'Gaseosa',0,NULL,1),(1083,5,'Jugo natural',0,NULL,1),(1084,5,'Agua saborizada',0,NULL,1),(1085,5,'Café',0,NULL,1),(1086,6,'Flan casero',0,NULL,1),(1087,6,'Ensalada de frutas',0,NULL,1),(1088,6,'Gelatina',0,NULL,1),(1089,6,'Yogur',0,NULL,1),(1090,6,'Helado',0,NULL,1);
...
INSERT INTO `comidas_restricciones` VALUES (1,'Sin TACC',NULL),(2,'Vegetariano',NULL);
...
INSERT INTO `comidas_tipos` VALUES (1,'Entradas',NULL),(2,'Plato Principal',NULL),(3,'Plato Alternativo',NULL),(4,'Plato Vegetariano',NULL),(5,'Bebidas',NULL),(6,'Postres',NULL);
...
INSERT INTO `estaciones` VALUES (2,'Invierno'),(4,'Otoño'),(3,'Primavera'),(1,'Verano');
...
CREATE TABLE `liquidaciones` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_liq_anio_mes` (`anio`,`mes`),
...
CREATE TABLE `personas` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_personas_id_usuario` (`id_usuario`),
  CONSTRAINT `fk_personas_usuarios` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `planificaciones_semanales` (
  ...
  KEY `idx_ps_id_temporada` (`id_temporada`),
  CONSTRAINT `fk_ps_temporadas` FOREIGN KEY (`id_temporada`) REFERENCES `temporadas` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reservas` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `id_usuario` int unsigned NOT NULL,
  `id_liquidacion` int unsigned DEFAULT NULL,
  ...
  KEY `idx_reservas_id_usuario` (`id_usuario`),
  KEY `idx_reservas_id_liquidacion` (`id_liquidacion`),
  ...
  CONSTRAINT `fk_reservas_liquidaciones` FOREIGN KEY (`id_liquidacion`) REFERENCES `liquidaciones` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_reservas_usuarios` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `roles` VALUES (2,'Administrador'),(1,'Empleado'),(3,'RRHH');
...
CREATE TABLE `temporadas` (
  ...
  KEY `fk_temporadas_estaciones` (`id_estacion`),
  CONSTRAINT `fk_temporadas_estaciones` FOREIGN KEY (`id_estacion`) REFERENCES `estaciones` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `temporadas` VALUES (1,1,2025,'2025-01-01','2025-03-31'),(2,2,2025,'2025-04-01','2025-06-30'),(3,3,2025,'2025-07-01','2025-09-30'),(4,4,2025,'2025-10-01','2025-12-31'),(5,1,2026,'2026-01-01','2025-03-31'),(6,2,2026,'2026-04-01','2025-06-30'),(7,3,2026,'2026-07-01','2025-09-30'),(8,4,2026,'2026-10-01','2025-12-31');
...
CREATE TABLE `usuarios` (
  ...
  `firebaseUID` varchar(128) COLLATE utf8mb4_general_ci NOT NULL,
  `activo` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_usuarios_email` (`email`),
  UNIQUE KEY `uk_usuarios_firebase` (`firebaseUID`)
...
-- Dump completed on 2025-09-23 15:39:45
